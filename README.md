...
The crawling of the pages is done like this: the body of the html is taken and a depth search is done on it to find keywords like "phone", "facebook", "instagram" and "address". The text containing that keyword is saved in one of the three fields above. 
